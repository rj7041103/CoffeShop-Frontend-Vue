...
.category-moca {
  background-image: linear-gradient(#00000080, #00000080),
    url('./assets/img/moca-category.jpg');
  background-size: cover;
...
.category-capuchino {
  background-image: linear-gradient(#00000080, #00000080),
    url('./assets/img/capuchino-category.jpg');
  background-size: cover;
  background-position: center;
  background-repeat: no-repeat;
}
...
.category-expreso {
  background-image: linear-gradient(#00000080, #00000080),
    url('./assets/img/expreso-category.jpg');
  background-size: cover;
  background-position: center;
  background-repeat: no-repeat;
}
...
@media (min-width: 1024px) {
  #app {
    ...
    padding: 0;
    width: 100vw; /* Asegura que el contenedor tome todo el ancho del viewport */
    margin: 0; /* Elimina márgenes que puedan afectar el ancho */
    place-items: center;
  }
}
